...
/**
 * @author zhangcanlong
 * @description 开源库识别语言的工具类
 * @since 2019-1-24
 **/
public enum LanguageDetectionUtil {
     ...
     **/
    public String detect(String languageStr) {
        // 创建识别器
        ...
        //List<DetectedLanguage> listLanguage = languageDetector.getProbabilities(textObject);
        if (!lang.isPresent()) {
